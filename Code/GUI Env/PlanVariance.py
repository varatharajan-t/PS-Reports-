# ************************************************************************************************************
# This program takes input .DAT file and outputs Excel file.
# To generate the DAT file select the classical drill down option then select Export option in the menu to export DAT file
# This conversion has the following key functions:
# [1] FileHandler: Opens a file dialog to select a DAT file and returns its path and name.
# [2] DataProcessor: Reads, cleans, and transforms the data by dropping unnecessary columns/rows, renaming headers,
#                   and splitting WBS Element Details into separate columns.
# [3] WBSUpdater: Updates the WBS descriptions in the transaction file using a master WBS names file.
# [4] ExcelFormatter: Applies formatting to the generated Excel file, including font style, currency formatting,
#                   column width adjustment, table creation, and header formatting.
# These functions together facilitate reading, processing, and formatting plant data from a DAT file,
# updating WBS descriptions, and saving the results in a well-formatted Excel file.
# ***************************************************************************************************************
...
class DataProcessor:
    ...
    def process_wbs(self, wbs_list):
        ...
        for wbs in wbs_list:
            ...
            if has_child:
                summary_wbs.append(wbs)  # Add to summary WBS
            else:
                transaction_wbs.append(wbs)  # Add to transaction WBS
...
def main():
    ...
    # print(data_processor.summary_wbs_list)
